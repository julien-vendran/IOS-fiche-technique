...
struct RecipeDTO {
    ...
    var nbOfCover : Int
    var category : String
    var listOfSteps : [RecipeDTO]
    
    var recipe: Recipe {
        return Recipe(name: self.name, responsable: self.responsable, nbOfCover: self.nbOfCover, category: self.category, listOfStep: [], id: self.id)
    }
}
